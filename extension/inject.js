...
(function() {
  ...
  function wrapMapConstructor(maps) {
    ...
    const WrappedMap = function(container, options) {
      ...
      // Wrap setOptions to prevent site from resetting maxZoom
  ...
  function wrapImageMapTypeConstructor(maps) {
    ...
    const WrappedImageMapType = function(options) {
      ...
      // Extend maxZoom on the layer so Google Maps requests tiles at higher zooms
  ...
  function startMonitoring() {
    ...
    // Continuous poll to guarantee coverage
