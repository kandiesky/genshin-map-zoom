...
(function() {
  ...
  function loadConfig() {
    try {
      ...
      console.warn('[GenshinMapZoom] Could not load config:', e);
    }
  ...
  function createHud() {
    ...
    document.getElementById('gmz-btn-in').addEventListener('click', () => {
      if (window.__genshinMap) {
        ...
        if (cur < max) window.__genshinMap.setZoom(cur + 1);
    ...
    document.getElementById('gmz-btn-out').addEventListener('click', () => {
      if (window.__genshinMap) {
        const cur = window.__genshinMap.getZoom() || 11;
        if (cur > 10) window.__genshinMap.setZoom(cur - 1);
      } else if (typeof window._mapSetZoom === 'function') {
    ...
    document.getElementById('gmz-btn-reset').addEventListener('click', () => {
      if (window.__genshinMap) window.__genshinMap.setZoom(11);
    });
  ...
  console.log('[GenshinMapZoom UserScript] Loaded successfully.');
})();
